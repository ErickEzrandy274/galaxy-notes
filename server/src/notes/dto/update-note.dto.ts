...
export class UpdateNoteDto {
  ...
  @ApiPropertyOptional({
    description: 'Storage path for attached document (null to remove)',
    nullable: true,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    example: 1,
    description: 'Current note version for optimistic locking',
  })
  @IsNumber()
  version: number;

  @ApiPropertyOptional({
    description: 'Whether to create a version snapshot (manual save)',
  })
  @IsOptional()
  @IsBoolean()
  snapshot?: boolean;
