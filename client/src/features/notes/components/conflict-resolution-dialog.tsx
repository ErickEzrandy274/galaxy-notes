    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
      ...
      <article className="relative z-10 w-96 rounded-lg border border-border bg-card p-6 shadow-xl">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-foreground">Edit Conflict</h4>
            <p className="mt-1 text-sm text-muted-foreground">
              This note has been modified by another user while you were editing. Choose how to resolve the conflict.
            </p>
          </div>
        </div>
